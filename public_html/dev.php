	...
	<div class="home">
		...
		<div class="home_slider_container">
			<div class="owl-carousel owl-theme home_slider">
				...
				<!-- Home Slider Item -->
				<div class="owl-item">
					<div class="home_slider_background" style="background-image:url(images/slider_44.png); background-size: 100%;"></div>
			...
			<div class="row test_slider_container">
				<div class="col">
					...
					<div class="owl-carousel owl-theme test_slider text-center">
						...
						<!-- Testimonial Item -->
						<div class="owl-item">
							<div class="test_text">“Esta pagina tiene el objetivo de informar y dar a conocer a la población los avances y actuaciones de la Comisión de Patrimonio de la Provincia de Salta.”</div>

				...
				<div class="row">
					<div class="col-lg-8">
						...
						<div class="reviews">
							...
							<div class="reviews_container">
								<ul>
									<?php 
											$sql1 = "SELECT * FROM `noticias` WHERE tipo = 1 AND activo=1 ORDER BY id DESC";
											...
											<ul>
												...
												<li class=' review clearfix'>
													<div class='review_image'><img src='admin/".$f['imagen']."' alt='' ></div>
													...
													echo "
														...
														<p>".substr($f['texto'], 0, 160)."... <a href='news.php?c=".$url."'>Leer Noticia</a></p>
					...
					<div class="col-md-4">
						<div class="container" style="margin-top: 4em;">
							<?php 
							$sql4 = "SELECT * FROM `noticias` WHERE tipo = 2 ORDER BY id DESC";
							$cons4 = mysqli_query($con,$sql4) or die (mysqli_error($con));
							$numFlyers= mysqli_num_rows($cons4);

							while ($f4= mysqli_fetch_array($cons4)) {
								echo "<img src='admin/".$f4['imagen']."' width='100%'>";
							}

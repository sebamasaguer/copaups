					...
					<div class="col">
						<div class="home_container">
							<div class="home_content">
								<div class="home_title">Trámites</div>
						...
						<div class="row">
							<div class="col">
								<div class="section_title_container text-center">
									<div class="section_subtitle">Guía de </div>
									<div class="section_title">Trámites</div>
								</div>
							</div>
						</div>
					...
					<div class="newsletter">
						<div class="newsletter_content">
								...
								<div class="row options" >
										...
										<a href="injerencias.php">
											<div class="options_item d-flex flex-row align-items-center justify-content-start">
												...
												<div class="option_content">
													<div class="option_title">Injerencias</div>
													<div class="option_subtitle">Servicios</div>
												</div>
											</div>
										</a>
									</div>
									...
									<!-- Options Item -->
									<div class="col-lg-6">
										<a href="consultaPrevia.php">
											<div class="options_item d-flex flex-row align-items-center justify-content-start">
												<span style="font-size: 48px; color: #ACA39A;">
													<i class="fas fa-file-export"></i>
												</span>
												<div class="option_content">
													<div class="option_title">Solicitudes</div>
													<div class="option_subtitle">Consulta Previa</div>
												</div>
											</div>
										</a>
									</div>
									...
									<div class="col-lg-6">
										<a href="cnoa.php">
											<div class="options_item d-flex flex-row align-items-center justify-content-start">
												...
												<div class="option_content">
													<div class="option_title">CNOA</div>
													<div class="option_subtitle">Certificado de no Objeción</div>
												</div>
											</div>
										</a>
									</div>
									...
									<div class="col-lg-6">
										<a href="anexoIV.php">
											<div class="options_item d-flex flex-row align-items-center justify-content-start">
												...
												<div class="option_content">
													<div class="option_title">Formulario</div>
													<div class="option_subtitle">Compra Inmueble de Interés Arquitectónico</div>
												</div>
											</div>
										</a>
									</div>
									...
									<div class="col-lg-6">
										<a href="anexoVI.php">
											<div class="options_item d-flex flex-row align-items-center justify-content-start">
												...
												<div class="option_content">
													<div class="option_title">Formulario</div>
													<div class="option_subtitle">Formulario Escribano Inmueble</div>
												</div>
											</div>
										</a>
									</div>
									...
									<div class="col-lg-6">
										<a href="anexoV.php">
											<div class="options_item d-flex flex-row align-items-center justify-content-start">
												...
												<div class="option_content">
													<div class="option_title">Formulario</div>
													<div class="option_subtitle">Incorporación de un Bien al BiPAUPS</div>
												</div>
											</div>
										</a>
									</div>

...
<html lang="es">
<head>
	<title>Consulta Previa | CoPAUPS</title>
	<meta charset="utf-8">
					...
					<div class="col">
						<div class="home_container">
							<div class="home_content">
								<div class="home_title">Consulta Previa</div>
				...
				<div class="row">
					...
					<div class="col-lg-8">
						<div class="billing">
							...
							<div class="letra">
							<h3 class="titu"><strong>INFORMACIÓN</strong></h3>
							<p class="subtitu">SOLICITUD CONSULTA PREVIA</p> <br>
							<div class="borde" style="border-bottom: dotted 4px; margin-bottom: 2em;"></div>
							<div class="cuerpo">
								<ul style="list-style: square; font-size: 1.2em; margin-left: 1.8em;">
									<li>
										RÉGIMEN VOLUMÉTRICO. 
									</li>
					...
					<div class="col-lg-4">
						<div class="billing">
							<br><br>
							<img src="images/formulario1.jpg" style="width: 100%;">
						</div>
					</div>
				</div> <br> 
				<div class='embed-responsive' style='padding-bottom:150%'>
					<object data='docs/CONSULTA PREVIA.pdf' type='application/pdf' width='100%' height='100%'></object>
				</div>

...
<body>
	...
	<div class="super_container">
		...
		<div class="home">
			<div class="home_background parallax-window" data-parallax="scroll" data-image-src="images/cabildo.jpg" data-speed="0.8"></div>
			<div class="container">
				<div class="row">
					<div class="col">
						<div class="home_container">
							<div class="home_content">
								<div class="home_title">Proyectos</div>
		...
		<div class="checkout">
			<div class="container">
				...
				include('admin/conection.php');
					$sql = "SELECT * FROM obras WHERE estado = 1 ORDER BY id DESC";
					...
					while ($f= mysqli_fetch_array($cons)) {
						...
						echo "<div id='carouselExampleControls".$cont."' class='carousel slide' data-ride='carousel'>
						<div class='carousel-inner'>";

						$sql1 = "SELECT * FROM galeriaObras WHERE idObra = $idObra";
						$cons1 = mysqli_query($con,$sql1) or die (mysqli_error($con));
						$b=0;
						while ($f1= mysqli_fetch_array($cons1)) {
							if ($b==0) {
								echo "<div class='carousel-item active'>
							<img src='".$f1['img']."' class='d-block w-100' alt='...'>
							</div>";
							$b=1;
							}else{
						...
						echo "</div>
						<a class='carousel-control-prev' href='#carouselExampleControls".$cont."' role='button' data-slide='prev'>
						<span class='carousel-control-prev-icon' aria-hidden='true'></span>
						<span class='sr-only'>Previous</span>
						</a>
						<a class='carousel-control-next' href='#carouselExampleControls".$cont."' role='button' data-slide='next'>

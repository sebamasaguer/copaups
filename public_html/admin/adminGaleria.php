	...
	<div class="super_container"><!-- Header -->
		...
		<div class="checkout" style="margin-top: 10em; ">
			<div class="container" >
				...
				<h3>Galería Antes y Después(Pestaña)</h3>
				<a class="btn btn-secondary" id="btnNuevaImagen">Nueva imagen</a>
				...
				<div class="checkout">
					<div class="container" style="width: 80%;">
						...
						<div class="row" id="contenedorGaleria">
											...
											if (mysqli_num_rows($cons) > 0) {
												while ($f= mysqli_fetch_array($cons)) {
														...
														echo "<!-- Review -->
														<div class='review clearfix' style='border: 1px solid #000; padding: 2em;'>
														<div class='review_image'><img src='".$f['miniatura']."' alt=''></div>
														<div class='review_content'>";
														
														$id= cryptozero(1,$f['id']);
														echo"
														<div class='review_name'><a>".$f['caption']."</a></div>";
														$fecha=  $f['fecha'];
														echo "
														...
														<img src='".$f['imagen']."' width='200px'><br>Full
														</div>
														<hr>
														
														<button class='btn btn-danger' data-id='".$f['id']."' id='btnEliminarImagenGaleria'>Eliminar</button>";
												...
												echo "<h4>No hay imagenes aún.</h4>";
											}
...
<!-- Nuevo Flyer-->
<div class="modal fade bd-example-modal-lg" tabindex="-1" role="dialog" aria-labelledby="myExtraLargeModalLabel" aria-hidden="true" id="nuevaImagen">
	<div class="modal-dialog modal-lg">
		<div class="modal-content">
			<div class="modal-header">
				<h5 class="modal-title" id="exampleModalLabel">Nueva Imágen de Galería</h5>
			...
			<div class="modal-body">
				...
				<div style="margin-left: 4em;">
					<form id="formNuevaNoticiaFlyer" action="nuevaImagenGaleria.php" method="post" enctype="multipart/form-data">
						<input type="hidden" name="acc" value="addImagen">

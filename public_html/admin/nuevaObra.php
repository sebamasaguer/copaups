			...
			<div class="container" >
				...
				<div class="checkout">
					<div class="container" style="width: 80%;">
						...
						<form id="formNuevaObra" class="needs-validation" action="guardarObra.php" method="post" novalidate>
							<div class="form-row">
								<div class="col-md-12">
								...
								<div class="col-md-12">
									<label for="validationCustom02">Texto (Opcional)</label>
									
									<textarea  id="" cols="30" rows="10" name="texto" class="form-control" id="validationCustom02"></textarea>
									<div class="valid-feedback">
										Correcto!
									</div>

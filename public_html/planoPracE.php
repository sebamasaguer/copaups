		...
		<div class="checkout">
			<div class="container">
						...
						<div class="row">
							<div class="col">
								<div class="section_title_container text-center">
									<div class="section_subtitle">Plano PRAC</div>
									<div class="section_title">Sector E</div>
								</div>
							</div>
						</div>
				...
				<div class="container" id="directorio" style="width: 100%;">
					<a href="javascript:history.back()" class="btn btn-dark"> Volver Atrás</a> 
					
					<div class='embed-responsive' style='padding-bottom:150%'>
						<object data='docs/planoPracE.pdf' type='application/pdf' width='100%' height='100%'></object>
					</div>			

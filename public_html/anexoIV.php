					...
					<div class="col">
						<div class="home_container">
							<div class="home_content">
								<div class="home_title">Compra Inmueble de Interés Arquitectónico</div>
		...
		<div class="checkout">
			<div class="container">
				<div class="row">
					...
					<div class="col-lg-12">
						<div class="billing">
							...
							<p class="subtitu">Formulario</p> 
							<div class="borde" style="border-bottom: dotted 4px; margin-bottom: 2em;"></div><br>
				...
				<div class='embed-responsive' style='padding-bottom:150%'>
					<object data='docs/SOLICITUDCOMPRA.pdf' type='application/pdf' width='100%' height='100%'></object>
				</div>
